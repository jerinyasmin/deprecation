...
def findAPIDeprecated():
    ...
    files_dataset_standard = readFile("result/dataset/dataset_file.csv")
    apis = []
    ...
    # files_dataset_standard = ['APIs/dracoon.team/4.5.0/swagger.yaml', "APIs/bigoven.com/partner/swagger.yaml", "APIs/amazonaws.com/swf/2012-01-25/swagger.yaml"]

    # files_dataset_standard = ["APIs/googleapis.com/testing/v1/swagger.yaml"]
    # files_dataset_standard = ["APIs/amazonaws.com/iot/2015-05-28/swagger.yaml"]
    # files_dataset_standard = ["APIs/azure.com/recoveryservicesbackup-bms/2017-07-01/swagger.yaml"]
    # files_dataset_standard = ["APIs/amazonaws.com/swf/2012-01-25/swagger.yaml"]
    # files_dataset_standard = ["APIs/zuora.com/2019-09-19/swagger.yaml"]
    # files_dataset_standard = ["APIs/wmata.com/bus-route/1.0/swagger.yaml"]
    ...
    print(len(list(set(list(set(desc_apis)) + list(set(desc_apis))))))
